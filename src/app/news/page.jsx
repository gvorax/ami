                  ...
                  <div className={styles.bot_container}>
                    <div className={styles.bot_high}>
                      <div className={styles.bot_title_block}>
                        <span className={styles.bot_title}>НОВОСТИ</span>
                      </div>
                    ...
                    <div className={styles.rv}>
                      ...
                      <p className={styles.rv_text}>
                        В этом разделе находятся актуальные новости компании
                      </p>
                    </div>
                  </div>
                </div>
                <div className={styles.bot_decoration_bot}>
                  <div className={styles.bot_container_bot}>
                    <div className={styles.comments}>
                      <div className={styles.com_box}>
                        <div className={styles.com_img}>
                          <p>Искусственный интеллект</p>
                          <p>10.07.2023</p>
                        </div>

                        <div className={styles.com_img}>
                          <p className={styles.com_img_one}>
                            OpenAI привлек $300 млн при оценке в $27–29 млрд
                          </p>
                      ...
                      <div className={styles.com_box}>
                        ...
                        <div className={styles.com_img}>
                          <p className={styles.com_img_two}>
                            Парламент ЕС утвердил первые в мире комплексные
                            правила для криптоактивов
                          </p>
                          <div className={styles.svg_box}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
